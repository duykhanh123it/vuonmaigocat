...
const Home: React.FC<HomeProps> = ({ setCurrentPage }) => {
  const images = [anhMai1, anhMai2, anhMai3, anhMai4];

  return (
    <div>
      {/* Hero Section */}
      <section className="relative h-[600px] flex items-center justify-center text-white overflow-hidden">
        <img src={anhBiaHeader} alt="hero" className="absolute inset-0 w-full h-full object-cover brightness-50" />
      ...
      <section className="bg-slate-50 pb-20">
        <div className="container mx-auto px-4">
          <div className="relative z-10 -mt-10 md:-mt-14 lg:-mt-20">
            <div className="max-w-4xl mx-auto bg-secondary/10 rounded-2xl shadow-xl overflow-hidden md:flex">
              <div className="p-8 md:p-12 text-center flex-1">
                <h2 className="text-3xl font-bold font-serif text-secondary mb-6 uppercase tracking-wider">
                ...
                <p className="text-slate-600 leading-relaxed">
                  ...
                  Với kinh nghiệm trên 25 năm, chúng tôi mang đến những cây mai đẹp nhất, được chăm sóc tỉ mỉ từ nghệ nhân
                  giàu tâm huyết, đảm bảo mỗi khách hàng đều có một mùa Tết thật trọn vẹn và ý nghĩa.
                </p>
              </div>
            </div>
          </div>
